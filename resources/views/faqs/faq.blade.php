            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <p class="text-muted">General knowledge is information that has been accumulated over time
                            through various mediums and sources. It excludes specialized learning that can only be
                            obtained with extensive training and information confined to a single medium.</p>
                    </div>
                    <!--end col-->
                    <div class="col-xl-8">
                        <div class="accordion accordion-border-box" id="genques-accordion">
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        website that provides answers to common questions, assuages concerns, and
                                        overcomes objections. It's a space where customers away from your sales-focused
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        FAQ stands for Frequently Asked Questions. It's <b>your opportunity to
                                            communicate with the most important visitors to your website</b> – those who
                                        have begun the decision-making process about whether to do business with you
                                        can't fit elsewhere on their website.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        The purpose of a FAQ is generally to provide information on frequent questions
                                        or concerns; however, the format is a useful means of organizing information,
                                        and text consisting of questions and their answers may thus be called a FAQ
                                        regardless.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseFour" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        FAQs stand for frequently asked questions. It is one of the many crucial pages
                                        of your website. It gives your customers answers to recurring and common
                                        questions and addresses their concerns public product documentation that is
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseFive" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        These questions will help clients feel involved with the design process, and
                                        they'll also help you brainstorm ideas and fine-tune your creative output.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="genques-collapseSix" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        Liedtka from Darden Business School and identifies four stages: What is?, What
                ...
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <p class="text-muted">Cybersecurity experts recommend changing your password every three months.
                            There may even be situations where you should change your password immediately, especially
                            if a cybercriminal has access to your account.</p>
                    </div>
                    <!--end col-->
                    <div class="col-xl-8">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <p class="text-muted">Privacy is the right to control how your information is viewed and used,
                            while security is protection against threats or danger. In the digital world, security
                            generally refers to the unauthorized access of data, often involving protection against
                            hackers or cyber criminals.</p>
                    </div>
                    <!--end col-->
                    <div class="col-xl-8">
