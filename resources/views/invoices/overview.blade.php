    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Invoice Overview</h4>
    ...
    <div class="row justify-content-center">
        <div class="col-xxl-9">
            <div class="hstack gap-2 justify-content-end d-print-none mb-4">
                ...
                <button type="button" id="download-button" class="btn btn-primary"><i
                ...
                <div class="card-body z-1 position-relative">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0 mt-sm-0 mt-3">
                            ...
                            <h6><span class="text-muted fw-normal">Email:</span> <span
                                    id="email">lodekibx@gmail.com</span></h6>
                            <h6><span class="text-muted fw-normal">Website:</span> <a href="#"
                                    class="link-primary" target="_blank" id="website">www.domain.com</a></h6>
                    ...
                    <div class="mt-5 pt-4">
                        <div class="row g-3">
                            ...
                            <div class="col-lg col-6">
                                ...
                                <h5 class="fs-md mb-0">Ksh <span id="total-amount">2,050.18</span></h5>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
                        ...
                        <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                            ...
                            <tbody id="products-list">
                                <tr>
                                    ...
                                    <td>Ksh 161.25</td>
                                    <td>03</td>
                                    <td class="text-end">Ksh 483.75</td>
                                </tr>
                                <tr>
                                    <th scope="row">02</th>
                                    <td class="text-start">
                                    ...
                                    <td>Ksh 69.60</td>
                                    <td>02</td>
                                    <td class="text-end">Ksh 139.20</td>
                                </tr>
                                <tr>
                                    <th scope="row">03</th>
                                    <td class="text-start">
                                    ...
                                    <td>Ksh 250.00</td>
                                    <td>06</td>
                                    <td class="text-end">Ksh 1,500.00</td>
                                </tr>
                                <tr>
                                    <th scope="row">04</th>
                                    <td class="text-start">
                    ...
                    <div class="border-top border-top-dashed mt-2" id="products-list-total">
                        <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto"
                            ...
                            <tbody>
                                <tr>
                                    <td>Sub Total</td>
                                    <td class="text-end">Ksh 2,272.95</td>
                                </tr>
                                <tr>
                                    <td>Estimated Tax <small class="text-muted">(18%)</small></td>
                                    <td class="text-end">Ksh 409.13</td>
                                </tr>
                                <tr>
                                    <td>Discount <small class="text-muted">(LORD)</small></td>
                                    <td class="text-end">-Ksh 681.88</td>
                                </tr>
                                <tr>
                                    <td>Shipping Charge</td>
                                    <td class="text-end">Ksh 65.00</td>
                                </tr>
                                <tr class="border-top border-top-dashed fs-15">
                                    <th scope="row">Total Amount</th>
                                    <th class="text-end">Ksh 2,050.20</th>
                                </tr>
                            </tbody>
                        </table>
                        <!--end table-->
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted mb-1">Card Number: <span class="fw-medium" id="card-number">xxx xxxx xxxx
                                1234</span></p>
                        <p class="text-muted mb-0">Total Amount: <span class="fw-medium">Ksh </span><span
                                id="card-total-amount">2,050.18</span></p>
                    </div>
                    <div class="mt-4 mb-4">
                        <div class="alert alert-success mb-0">
                            <span class="fw-semibold">NOTES:</span>
                            <span id="note">Congratulations on your recent payment!</b> It has been our pleasure to
                            serve you, and we hope we see you again soon.
                            </span>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="invoice-signature text-center">
                            <img src="assets/images/barcode.svg" alt="" id="sign-img" height="30">
